...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-pointer select-none items-center px-3 py-2.5 text-sm text-gray-700 bg-white outline-none hover:bg-gray-50 focus:bg-gray-50 data-[state=checked]:text-blue-600 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 border-b border-gray-100 last:border-b-0",
      className
    )}
    {...props}
  >
